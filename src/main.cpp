...
const string strMessageMagic = "DarkKnightsCoin Signed Message:\n";
...
{
    int64_t nRewardCoinYear = 999 * CENT;
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("DarkKnightsCoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in DarkKnightsCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // DarkKnightsCoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "DarkKnightsCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "DKC Genesis";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1470105018;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1217183; // !fTestNet ? 1575379 : 46534;
...
unsigned char pchMessageStart[4] = { 0xb4, 0xf1, 0xe9, 0xe5 };
