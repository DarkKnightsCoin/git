...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("DarkKnightsCoins"));
    case mBTC: return QString(QObject::tr("Milli-DarkKnightsCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-DarkKnightsCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
