...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("DarkKnightsCoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("DarkKnightsCoin-net");
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("DarkKnightsCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("DarkKnightsCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("DarkKnightsCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("DarkKnightsCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. DarkKnightsCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("DarkKnightsCoin-start");
