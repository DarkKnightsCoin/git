DarkKnightsCoin-qt: Qt4 GUI for DarkKnightsCoin
===============================
...
Alternatively, install Qt Creator and open the `DarkKnightsCoin-qt.pro` file.

An executable named `DarkKnightsCoin-qt` will be built.
...
A warning for people using the *static binary* version of DarkKnightsCoin on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of DarkKnightsCoin is linked against libdb5.3.
...
installed causes DarkKnightsCoin-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
